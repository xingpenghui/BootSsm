package com.feri.bootssm.config;
...
public class SwaggerConfig {
    ...
    public ApiInfo createAI(){
        ApiInfo apiInfo=new ApiInfoBuilder().title("天气预报小组手").description("实现一款小的天气预报").contact(new Contact("Feri","http://www.17feri.top","xingfei_work@163.com")).build();
        return apiInfo;
    }
    //创建Swagger扫描信息
    @Bean
